 ...
 * and file names.
 */
public class MyImage extends ImageBase {
    /**
    ...
    /**
     * Construct an Image from a byte array of @a imageData downloaded from a URL @a source.
     */
    public MyImage(URL sourceURL, byte[] imageData) {
        // Set the URL.
